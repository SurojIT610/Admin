...
// import '../../assets/css/demo.css'; // Import custom styles (if any)
...
import UserStat from "./Charts/UserStat";

// Assuming Font Awesome has already been configured globally
const DashBoardRowA = () => {
  return (
    <>
      <div className="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
          ...
          <h6 className="op-7 mb-2">Welcome Surojit Majumdar</h6>
        </div>
