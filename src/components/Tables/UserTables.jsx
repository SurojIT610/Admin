              ...
              <div className="row">
                ...
                <div className="col-md-6 col-lg-4">
                    ...
                    <div className="row gutters-xs">
                      ...
                      <div className="col-auto">
                        <label className="colorinput">
                          ...
                          />
                          <span
                            className="colorinput-color bg-primary"
                          ></span>
                        </label>
                      </div>
                      <div className="col-auto">
                        <label className="colorinput">
                          ...
                          />
                          <span
                            className="colorinput-color bg-secondary"
                          ></span>
                        </label>
                      </div>
                      <div className="col-auto">
                      ...
                      <div className="col-auto">
                        <label className="colorinput">
                          ...
                          />
                          <span
                            className="colorinput-color bg-success"
                          ></span>
                        </label>
                      </div>
                      <div className="col-auto">
                      ...
                      <div className="col-auto">
                        <label className="colorinput">
                          ...
                          />
                          <span
                            className="colorinput-color bg-warning"
                          ></span>
                        </label>
                      </div>
                    </div>
                  ...
                  <div className="form-group">
                    ...
                    <div
                      className="selectgroup selectgroup-secondary selectgroup-pills"
                    >
                      <label className="selectgroup-item">
                        <input
                          type="radio"
